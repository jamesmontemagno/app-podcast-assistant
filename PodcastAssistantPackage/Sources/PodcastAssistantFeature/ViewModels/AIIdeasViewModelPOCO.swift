...
/// ViewModel for AI-powered content generation from episode transcripts (POCO version)
@available(macOS 26.0, *)
@MainActor
public class AIIdeasViewModelPOCO: ObservableObject {
...
public extension AIIdeasViewModelPOCO {
